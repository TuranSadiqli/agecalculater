...
function ageInHours(){
    ...
    let birthday=prompt("ayin neçəsi dogulubsuz?")
    let date=new Date();
    let ageinhours=((((date.getFullYear()-(birthdate)-1)*365)+((12-(birthmonth-(date.getMonth()+1)))*31)+(31-(birthday-date.getDay())))*24)-12;
    let h1=document.createElement('h1');
...
function ageInMinutes(){
    ...
    let date=new Date();
    let ageinminutes=(((((date.getFullYear()-(birthdate)-1)*365)+((12-(birthmonth-(date.getMonth()+1)))*31)+(31-(birthday-date.getDay())))*24)*60)-12;
    let h1=document.createElement('h1');
